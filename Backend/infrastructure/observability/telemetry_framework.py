"""
Spatial Enterprise Observability Framework - Modular Version
...
class SpatialObservabilityFramework:
    """Enterprise-grade observability framework for Spatial Platform"""
    ...
    def __init__(
        ...
        logger.info(f"Spatial Observability Framework initialized for {self.service_name}")
    ...
    def instrument_fastapi_app(self, app):
        ...
        logger.info(f"📊 Instrumenting FastAPI app for {self.service_name}")
        return app
...
_observability_framework: Optional[SpatialObservabilityFramework] = None

def get_observability() -> Optional[SpatialObservabilityFramework]:
    """Get global observability framework instance"""
    return _observability_framework

def set_observability(framework: SpatialObservabilityFramework):
...
def create_service_instrumentation(service_type: ServiceType, **kwargs):
    ...
    framework = SpatialObservabilityFramework(service_type, **kwargs)
    set_observability(framework)
    # Return tuple of (framework, instrumentation) for compatibility
    # The framework itself acts as the instrumentation object
    return framework, framework

def create_ar_instrumentation(framework):
    """Create AR instrumentation components"""
    # Return AR-specific instrumentors (placeholder for now)
    return framework, framework

def create_enterprise_monitoring(framework):
    """Create enterprise monitoring components"""
    # Return alert manager (placeholder for now)
    return framework