# Spatial Service Instrumentation
# Service-specific OpenTelemetry integration for each Spatial component
...
class SpatialServiceRegistry:
    """Registry for all Spatial service instrumentations"""
    ...
    def register_service(
        ...
        """Register and instrument a Spatial service"""
...
service_registry = SpatialServiceRegistry()
...
def initialize_service_observability(
    ...
    """
    One-stop initialization for Spatial service observability
...
def setup_graceful_shutdown():
    ...
    def shutdown_handler(signum=None, frame=None):
        logger.info("🔄 Gracefully shutting down Spatial observability...")
        service_registry.shutdown_all()
        logger.info("✅ Spatial observability shutdown complete")
