"""
Spatial Enterprise Observability - Custom Decorators
    ...
    **attributes
    ...
    with tracer.start_as_current_span(operation_name) as span:
        try:
            ...
            span.set_attributes({
                "spatial.performance.critical": True,
                "spatial.performance.target_ms": target_duration_ms,
                "spatial.service.tier": performance_tier.value,
                **{f"spatial.{k}": v for k, v in attributes.items()}
            })
            ...
            span.set_attribute("spatial.performance.actual_ms", duration_ms)
            
            # Record SLA compliance
            sla_met = duration_ms <= target_duration_ms
            span.set_attribute("spatial.performance.sla_met", sla_met)
