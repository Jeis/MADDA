"""
Spatial Enterprise Observability - Custom AR Metrics
...
def create_base_metrics(meter: metrics.Meter) -> Dict[str, Any]:
    """Create base enterprise metrics for all Spatial services"""
