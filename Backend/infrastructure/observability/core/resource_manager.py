"""
Spatial Enterprise Observability - Resource Management
OpenTelemetry resource creation and configuration for Spatial services
"""
...
def get_default_resource_attributes() -> dict:
    """Get default Spatial platform resource attributes"""
    return {
        ResourceAttributes.SERVICE_NAMESPACE: "spatial.platform",
        
        # Spatial-specific attributes
        "spatial.platform.name": "spatial-ar-enterprise",
        "spatial.platform.version": "2.0.0",
...
def create_resource(
    ...
    """Create comprehensive resource description for Spatial service"""
    ...
    attributes = {
        ...
        # Spatial-specific attributes
        "spatial.service.type": service_type.value,
        "spatial.performance.tier": performance_tier.value,
